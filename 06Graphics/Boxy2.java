...
class Boxy2 extends Canvas
{
	public void paint( Graphics window )
	{
		...
		drawBox( window, Color.CYAN, 110, 20 );
		drawBox( window, Color.GRAY, 220, 40 );
		drawBox( window, Color.MAGENTA, 10, 100 );
		drawBox( window, Color.ORANGE, 300, 130 );
		drawBox( window, Color.PINK, 0, 300 );
		drawBox( window, Color.GREEN, 500, 300 );
		drawBox( window, Color.DARK_GRAY, 650, 0 );
		drawBox( window, Color.LIGHT_GRAY, 510, 400 );
		drawBox( window, Color.YELLOW, 600, 40 );
	...
	public void drawBox( Graphics window, Color c, int x, int y )
	{
		...
		//drawBox( window, Color.BLACK, 350, 450 );
		//drawBox( window, Color.RED, 350, 450 );
	}
